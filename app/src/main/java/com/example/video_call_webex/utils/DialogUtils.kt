package com.example.video_call_webex.utils
...
fun showDialogWithMessage(context: Context, title: String, message: String, positiveButtonText: Int = R.string.ok, cancelable: Boolean = true,
                          onPositiveButtonClick: (DialogInterface, Int) -> Unit, negativeButtonText: Int = R.string.cancel, onNegativeButtonClick: (DialogInterface, Int) -> Unit) {
